<template>
	<main class="content container" v-if="productLoading">Loadings...</main>
	<main class="content container" v-else-if="productLoadingFailed"> loading failed...</main>
          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              <div class="form__counter">
                <button type="button" aria-label="Убрать один товар" @click="productAmount = productAmount-1">
                ...
                <button type="button" aria-label="Добавить один товар" @click="productAmount = productAmount+1"> 
                  <svg width="12" height="12" fill="currentColor">
